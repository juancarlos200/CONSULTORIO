public class Main {
    public static void main(String[] args) {
        ...
        // Crear un encargado
        Encargado encargado = new Encargado("Carlos Pérez", 12345678, "carlos@gmail.com");

        // Crear una mascota
        Mascota mascota = new Mascota("Firulais", "Labrador", "Perro", 5);

        // Crear una consulta
        Consulta consulta = new Consulta("Chequeo general", 20/05/2025, 25f, "Vitaminas y dieta balanceada");
